...
$result_books = $connection->query($sql_books);
...
foreach ($books as $book) {
    ...
    $result_authors = $connection->query($sql_authors);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result_book_id = $connection->query($sql_book_id);
    if ($result_book_id->num_rows > 0) {
        ...
        $result_check_review = $connection->query($sql_check_review);
        if ($result_check_review->num_rows == 0) {
            // Insert the review in the review table
            $sql_insert_review = "INSERT INTO review (user_id, book_id, rating, review) VALUES ('$user_id', '$book_id', '$rating', '$review')";
            if ($connection->query($sql_insert_review) === TRUE) {
                ...
                $warning_message = "Error: " . $connection->error;
            }
        } else {
            $warning_message = "Review already exists. You can update it !!";
        }
    } else {
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" href="create.php">Write a review</a>
                    </li>
                    <li class="nav-item">
